    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Configurador de UI Material</h5>
          <p>Vea nuestras opciones de dashboard.</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="mt-3">
          ...
          <p class="text-sm">Elige entre diferentes tipos de barra lateral.</p>
        </div>
        <div class="d-flex">
        ...
        <p class="text-sm d-xl-none d-block mt-2">Puedes cambiar el tipo de barra lateral solo en vista de escritorio.</p>
        <!-- Navbar Fixed -->
