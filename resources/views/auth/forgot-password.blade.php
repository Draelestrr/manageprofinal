...
<head>
  ...
  <title>
    ManagePRO - Recuperar Contraseña
  </title>
  <!-- Fonts and icons -->
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Recuperar Contraseña</h4>
                </div>
              </div>
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="text-start">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Enviar Enlace de Recuperación</button>
                  </div>
                </form>
              </div>
            </div>
